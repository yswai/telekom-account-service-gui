<template>
  <div>
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
              ...
              <a href="#" class="block hover:bg-gray-50">
               ...
               <div class="mt-2 flex justify-between">
                ...
                <div class="mt-2 flex justify-between">
                    <div class="sm:flex">
                    <div class="mr-6 flex items-center text-sm text-gray-500">
                    <button @click='onCloseAccount(item)' class="font-bold py-2 px-4 rounded bg-blue-500 text-white">
                      Close Account
                    </button>
                    </div>
                    </div>
      ...
      <hr/>
      <div class="px-4 py-4 sm:px-6">
        <button @click="createInvestmentAccount()" class="font-bold py-2 px-4 rounded bg-blue-500 text-white">
...
export default Vue.extend({
  ...
  methods: {
    onCloseAccount(account: any) {
        var isDelete = window.confirm("Are you sure you want to delete investment account '" + account.accountNumber + "'? " + 
        "Note: Amount 'MYR " + account.balance + "' will be returned to Savings account after closure.");
        if (isDelete) {
          const headers = { 
          ...
          fetch("http://localhost:8080/v1/accounts/investments/" + account.id, requestOptions)
    ...
    createInvestmentAccount() {
      var accountName = window.prompt("Please enter desired investment account name: ");
        var requestBody = {
          accountName: accountName || "Investment Account (C)",
